...
\\\\pseudocode/plan////
split the string by the hyphens, the product number is always the second element for the end
rever the split string and returng the second element
*/
...
console.log(getProductId('exampleshop.com/dry-water-just-add-water-to-get-water-p-147-24122017.html'))
