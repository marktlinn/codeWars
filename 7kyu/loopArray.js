...
\\\\pseudocode////
if "left" copy arr from index of "steps" until end of arr. Append to arr copy of arr from index 0 - "steps"
*/
...
function loopArr(arr, direction, steps) {
  return direction === "left"
    ...
    : [...arr.slice(arr.length - steps), ...arr.slice(0, arr.length - steps)];
}
