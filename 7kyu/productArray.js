...
\\\\pseudocode////
map over the array, for each number reduce the whole array and divide out the current digit and return that new element;
*/

function productArray(numbers) {
  return numbers.map(elem => numbers.reduce((ttl, curr) => ttl * curr) / elem);
}
