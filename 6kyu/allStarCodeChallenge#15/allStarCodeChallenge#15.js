...
/*
Pseudocode:
Initialise an empty array to hold the strings
Run a loop for the length of the given string
  push to the array two string slices: 
    a slice from index to the end of the string + a slice from 0 to the index
return the array
*/
...
function rotate(str) {
  ...
  for (let i = 1; i <= str.length; i++) {
    rotatedStrings.push(str.slice(i) + str.slice(0, i));
  }
