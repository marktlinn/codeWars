/*
Link: 
https://www.codewars.com/kata/5acd142a2ec8c48521000104/javascript
...
\\\\pseudocode////
A simple challenge in terms of code, to use a map over an array and return square of each digit together as a unified number.
*/

//first solution, posted solution was without spacing or semicolon.
sd = x => [...("" + x)].map(e => e * e).join``;

//Second uses replace to use fewer characters, it searches for any value, then uses that value as the bases of its second arugment callback function, where it is squared and returned. Again posted solution was without spacing or semicolon
sd = x => +("" + x).replace(/./g, e => e * e);
